package com.tochycomputerservices.jobportal.activities;
...
import com.tochycomputerservices.jobportal.activities.WPML.LangArray;
...
import com.tochycomputerservices.jobportal.candidate.dashboard.Nokri_CandidateDashboardActivity;
import com.tochycomputerservices.jobportal.guest.dashboard.Nokri_GuestDashboardActivity;
...
import com.tochycomputerservices.jobportal.employeer.dashboard.Nokri_EmployerDashboardActivity;
                ...
                if (responseObject.isSuccessful()) {
                    ...
                    try {
                        ...
                        if (jsonObject.getBoolean("success")) {
                            ...
                            Nokri_SharedPrefManager.saveLocationSettings(locationModel,Nokri_SplashActivity.this);
                            ...
                            sharedPrefManager.setWPMLSettings(wpmlModel, Nokri_SplashActivity.this);
                            ...
                            if (!Nokri_SharedPrefManager.isSocialLogin(Nokri_SplashActivity.this)
                                    && Nokri_SharedPrefManager.getEmail(Nokri_SplashActivity.this) != null
                                    && Nokri_SharedPrefManager.getPassword(Nokri_SplashActivity.this) != null) {

                            } else if (Nokri_SharedPrefManager.isSocialLogin(Nokri_SplashActivity.this)
                                    && Nokri_SharedPrefManager.getEmail(Nokri_SplashActivity.this) != null) {

                            } else {
                                if (firstTime) {
                                    startActivity(new Intent(Nokri_SplashActivity.this, WpmlActivity.class).putExtra("firstTime",firstTime));
                                }else{
                            ...
                            if (loginDataArrived) {
                                if (signInType.equals("cand")) {
                                    ...
                                    startActivity(new Intent(Nokri_SplashActivity.this, Nokri_EmployerDashboardActivity.class));
...
//                    }
            ...
            public void onFailure(Call<ResponseBody> call, Throwable t) {
                Toast.makeText(Nokri_SplashActivity.this, t.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
                        ...
                        if (respone.getBoolean("success")) {
                            ...
                            if (data.getString("user_type").equals("0")) {
                                if (splashDataArrived) {
                                    Nokri_SharedPrefManager.saveAccountType("candidate", Nokri_SplashActivity.this);
                                    Intent i = new Intent(Nokri_SplashActivity.this, Nokri_CandidateDashboardActivity.class);
                                    if (adId != null) {
