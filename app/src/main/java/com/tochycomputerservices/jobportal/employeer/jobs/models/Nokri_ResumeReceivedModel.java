...
public class Nokri_ResumeReceivedModel {
    ...
    private ArrayList<QuestionnaireModel> questions;
    ...
    public ArrayList<QuestionnaireModel> getQuestions() {
        return questions;
    }

    public void setQuestions(ArrayList<QuestionnaireModel> questions) {
