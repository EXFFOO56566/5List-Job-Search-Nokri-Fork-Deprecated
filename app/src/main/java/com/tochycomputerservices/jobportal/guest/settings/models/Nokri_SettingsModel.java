package com.tochycomputerservices.jobportal.guest.settings.models;
...
public class Nokri_SettingsModel {
    ...
    private String externalApplyHeading;
    private String externalApplyText;
    public static String externalLinkHint;
    public static String externalEmailHint;
    public static String whatsAppHint;
    public String passwordMismatchString;
    public String confirmPasswordString;
    public String appliedAlreadyString;

    public String getAppliedAlreadyString() {
        return appliedAlreadyString;
    }

    public void setAppliedAlreadyString(String appliedAlreadyString) {
        this.appliedAlreadyString = appliedAlreadyString;
    }
    ...
    public String getPasswordMismatchString(){
        return passwordMismatchString;
    }

    public void setPasswordMismatchString(String passwordMismatchString){
        this.passwordMismatchString = passwordMismatchString;
    }

    public String getExternalApplyHeading() {
        return externalApplyHeading;
    }

    public void setExternalApplyHeading(String externalApplyHeading) {
        this.externalApplyHeading = externalApplyHeading;
    }

    public String getExternalApplyText() {
        return externalApplyText;
    }

    public void setExternalApplyText(String externalApplyText) {
        this.externalApplyText = externalApplyText;
    }
    ...
    public boolean isCatTempOn() {
        return isCatTempOn;
    }

    public void setCatTempOn(boolean catTempOn) {
        isCatTempOn = catTempOn;
    }

    public static boolean isCatTempOn;
