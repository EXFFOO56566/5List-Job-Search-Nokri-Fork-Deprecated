package com.tochycomputerservices.jobportal.manager;
...
import com.tochycomputerservices.jobportal.activities.WPML.WPMLModel;
import com.tochycomputerservices.jobportal.candidate.dashboard.models.Nokri_CandidateDashboardModel;
import com.tochycomputerservices.jobportal.employeer.EmployerSearch.EmployerSearchModel;
import com.tochycomputerservices.jobportal.employeer.dashboard.models.Nokri_EmployeerDashboardModel;
import com.tochycomputerservices.jobportal.employeer.payment.models.Nokri_PricingModel;
import com.tochycomputerservices.jobportal.guest.dashboard.models.Nokri_GuestDashboardModel;
import com.tochycomputerservices.jobportal.guest.home.models.Nokri_RateAppModel;
import com.tochycomputerservices.jobportal.guest.models.Nokri_MenuActiveJobsModel;
import com.tochycomputerservices.jobportal.guest.models.Nokri_MenuJobModel;
import com.tochycomputerservices.jobportal.guest.models.Nokri_MenuResumeReceivedModel;
import com.tochycomputerservices.jobportal.guest.models.Nokri_MenuSavedJobsModel;
import com.tochycomputerservices.jobportal.guest.search.models.LocationModel;
import com.tochycomputerservices.jobportal.guest.search.models.Nokri_CandidateSearchModel;
import com.tochycomputerservices.jobportal.guest.search.models.Nokri_JobSearchModel;
import com.tochycomputerservices.jobportal.guest.settings.models.Nokri_SettingsModel;
import com.tochycomputerservices.jobportal.manager.models.Nokri_PopupModel;
import com.tochycomputerservices.jobportal.manager.models.Nokri_ProgressModel;
import com.tochycomputerservices.jobportal.manager.notification.FireBaseNotificationModel;
...
public class Nokri_SharedPrefManager {
    ...
    public static void isLoginFromLinkedin(Boolean email, Context context) {
        SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(context);
        SharedPreferences.Editor editor = preferences.edit();
        editor.putBoolean("isLoginFromLinkedIn", email);
        editor.apply();
    }


    public void setWPMLLanguage(String firstTime,Context context){
        SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(context);
        SharedPreferences.Editor editor = preferences.edit();
        editor.putString("language", firstTime);
        editor.apply();
    };

    public String getWPMLLanguage(Context context){
        return PreferenceManager.getDefaultSharedPreferences(context).getString("language", "");
    }

    public void setFirstTime(boolean firstTime,Context context){
        SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(context);
        SharedPreferences.Editor editor = preferences.edit();
    ...
    public void setWPMLSettings(WPMLModel model, Context context) {
        Gson gson = new Gson();
        String wpmlSettings = gson.toJson(model);
        SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(context);
        SharedPreferences.Editor editor = preferences.edit();
        editor.putString("wpml_settings", wpmlSettings);
        editor.apply();

    }


    public static WPMLModel getWPMLSettings(Context context) {


        Gson gson = new Gson();
        String wpmlSettings = PreferenceManager.getDefaultSharedPreferences(context).getString("wpml_settings", null);
        WPMLModel model = gson.fromJson(wpmlSettings, WPMLModel.class);
        return model;
    }

    public static Boolean getIsLoginFromLinkedIn(Context context) {
        return PreferenceManager.getDefaultSharedPreferences(context).getBoolean("isLoginFromLinkedIn", false);
    }
    ...
    public static void saveLocationSettings(LocationModel model, Context context) {
        Gson gson = new Gson();
        String candidateSettings = gson.toJson(model);
        SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(context);
        SharedPreferences.Editor editor = preferences.edit();
        editor.putString("locationSettings", candidateSettings);
        editor.apply();

    }


    public static LocationModel getLocationSettings(Context context) {


        Gson gson = new Gson();
        String candidateSettings = PreferenceManager.getDefaultSharedPreferences(context).getString("locationSettings", null);
        LocationModel model = gson.fromJson(candidateSettings, LocationModel.class);
        return model;
    }
    ...
    public static void saveEmployerSearchModel(EmployerSearchModel model, Context context) {
        Gson gson = new Gson();
        String candidateSettings = gson.toJson(model);
        SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(context);
        SharedPreferences.Editor editor = preferences.edit();
        editor.putString("employer_search", candidateSettings);
        editor.apply();

    }

    public static EmployerSearchModel getEmployerSearchModel(Context context) {


        Gson gson = new Gson();
        String candidateSettings = PreferenceManager.getDefaultSharedPreferences(context).getString("employer_search", null);
        EmployerSearchModel model = gson.fromJson(candidateSettings, EmployerSearchModel.class);
        return model;
    }
